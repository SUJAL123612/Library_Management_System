    ...
    <>
      <nav className="text-white bg-black/90  border-transparent h-37  flex">
        ...
        <ul className="ml-[470px] mt-[70px]">
          ...
          <li className="inline-block mr-8 mb-8 text-[23px] font-sans text-white cursor-pointer hover:text-[#00FFFF]"><Link href="#books">Books</Link></li>
          ...
          <li className="inline-block mr-8 mb-8 text-[23px] font-sans text-white cursor-pointer hover:text-[#00FFFF]"><Link href="#sign-up">Sign-Up</Link></li>
