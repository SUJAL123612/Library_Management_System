    ...
    <>
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center -mt-[130px]">
          <h1 className="text-[#FFFFFF] text-5xl font-bold drop-shadow-lg mb-6 cursor-default">User Login Form</h1>
          ...
          <form className="flex flex-col items-center w-full max-w-sm gap-4">
            <input type="text" placeholder="Username" className="w-full px-4 py-2 rounded-md bg-white/70 text-gray-800 placeholder-gray-600 focus:outline-none" />
            <input type="password" placeholder="Password" className="w-full px-4 py-2 rounded-md bg-white/70 text-gray-800 placeholder-gray-600 focus:outline-none" />
            <button type="submit" className="w-full bg-[#4A90E2] text-white font-semibold py-2 rounded-md hover:bg-[#3B7ACC] transition">Login</button>
          </form>
